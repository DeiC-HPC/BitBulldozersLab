...
echo "Running with MPICH runtime environment using:"
which mpirun
which python3
...
mpirun -n 2 -F mpich -T openmpi python3 bandwidth.py

echo "-F self -T self"
mpirun -n 4 -F mpich -T mpich python3 init.py
mpirun -n 4 -F mpich -T mpich python3 ring.py
mpirun -n 2 -F mpich -T mpich python3 bandwidth.py
